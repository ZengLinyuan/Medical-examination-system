      ...
      <el-form ref="elForm" :model="formData" :rules="rules" size="medium" label-width="100px">
        ...
        <el-col :span="24">
          <el-form-item label="负责医生建议" prop="conclusions">
            <el-input v-model="formData.conclusions" placeholder="请输入负责医生建议" clearable
              :style="{width: '100%'}"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="是否驳回" prop="leader_audit">
            <el-cascader v-model="formData.doctor_audit" :options="leader_auditOptions"
...
export default {
  ...
  data() {
    return {
      formData: {
        ...
        surger_doctor_opinion: undefined,
      ...
      rules: {
        ...
        laboratory_edoctor_opinion: [],
        chest_radiography: [],
        chest_doctor_opinion: [],
        other_examination: [],
  ...
  methods: {
    submitForm() {
      ...
      this.$router.push({ path: "/doctor/index" || "/" }).catch(()=>{});uuuuuuuuuuuuuuuuuuuuuu
    },
    resetForm() {
